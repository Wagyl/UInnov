...
Le principe le plus basique, qui est celui du modèle à widget evoqué
...
la relantion \og menu \fg{} qui est, à un niveau basique, présente
...
d'un tel modèle (rélféxion en cours).
